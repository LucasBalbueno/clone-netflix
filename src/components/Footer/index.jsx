        ...
        <>
            <Container>
                <div className="footerContent">
                    ...
                    <a className="codeService" href="#">Código de serviço</a>

                    <p className="textFooter">© 1997-2024 Netflix, Inc.</p>
                </div>
            </Container>
        </>
    )
